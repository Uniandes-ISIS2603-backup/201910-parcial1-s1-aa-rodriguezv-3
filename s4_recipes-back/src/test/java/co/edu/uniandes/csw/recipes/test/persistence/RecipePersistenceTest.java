...
public class RecipePersistenceTest {
    ...
    public void createRecipeTest() {
        ...
        RecipeEntity recipe = em.find(RecipeEntity.class, result.getId());
        Assert.assertEquals(newEntity.getName(), recipe.getName());
        Assert.assertEquals(newEntity.getDescription(), recipe.getDescription());
    }
}
